...
public class SQLiteHandler extends SQLiteOpenHelper
{
    ...
    private static final String KEY_DIGIPOINTS = "digipoints";
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("totalpoints", cursor.getString(cursor.getColumnIndex("totalpoints")));
            user.put("digipoints", cursor.getString(cursor.getColumnIndex("digipoints")));
