...
public class Pointcalculator extends AppCompatActivity
{
    ...
    public int androidimpre;
    public String strimpre;
    public String ttlp;
    public String cp;
    ...
    private void fetchimpre( )
    {
        // Tag used to cancel the request
        String tag_string_req = "fetch_impre";
...
//         Toast.makeText(Pointcalculator.this,"in fetch", Toast.LENGTH_LONG).show();
       //   pD.setMessage("Fetching Points ...");
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_FETCH_IMPRESSION, new Response.Listener<String>()
        {
            ...
            public void onResponse(String response)
            {
                ...
                try {
                    ...
                    if(!error) {
                        ...
                        String impre = (user.getString("android"));
                        Log.d("impression", impre);
                        ...
                        try {
                            androidimpre = Integer.parseInt(impre);
    ...
    private void insertimpre( final int impre)
    {

        // Tag used to cancel the request
        String tag_string_req = "insert_impre";
        Log.d("insert", "inserttttttttttttttt");

        strimpre = String.valueOf(impre);
        // Toast.makeText(Pointcalculator.this,"in fetch", Toast.LENGTH_LONG).show();
          //pD.setMessage("inserting Points ...");
        showDialog(10);

        StringRequest strReq = new StringRequest(Request.Method.POST, AppConfig.URL_INSERT_IMPRESSION, new Response.Listener<String>()
        {
            ...
            public void onResponse(String response)
            {
                try {
                    Log.d(TAG, "onResponse");
                    Log.d(TAG, "insert  impre RESPONSE: " + response.toString());
                    JSONObject jObj = new JSONObject(response);
                    // boolean error = jObj.getBoolean("error");
                    //  if (!error)
                    //  {
        ...
        }, new Response.ErrorListener()
        {
            ...
            public void onErrorResponse(VolleyError error)
            {
                Log.e(TAG, "impression Inserting Error: " + error.toString());
                // Toast.makeText(getApplicationContext(), error.getMessage(), Toast.LENGTH_LONG).show();
                //hideDialog();
            }
        }) {
                    ...
                    if(!error) {
                        ...
                        try {
                            ...
                            if(company == 1 )
                            {
                                ...
                                fetchimpre();
                                androidimpre = androidimpre + 1;
                                insertimpre(androidimpre);
