...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        beaconManager.setMonitoringListener(new BeaconManager.MonitoringListener() {
            ...
            public void onEnteredRegion(Region region, List<Beacon> beacons) {
                ...
                Log.d(TAG, "entered");
                Toast.makeText(MainActivity4.this, "Entered", Toast.LENGTH_LONG).show();
                if (region == textilePage2) {
                    showNotification1("Bluedot", " Ajans e Aftab!");


                } else if (region == textilePage1) {
                    showNotification2("Bluedot", "Pishnahade vije bank e gardeshgari");
            ...
            {
                Log.d(TAG, "exited");
                Toast.makeText(MainActivity4.this, "Exited", Toast.LENGTH_LONG).show();
                NotificationManager mNotificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
                mNotificationManager.cancel(1);

                Notification noti = new Notification.Builder(MainActivity4.this)
    ...
    public void digi1(View view)
    {
        ...
        goToUrl("http://www.tourismbank.ir");
        //  }
